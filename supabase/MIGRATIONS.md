...
**Status: 38 of 39 applied.** #39 (`add-listing-availability.sql`) is **NOT YET RUN** —
the dish availability/timing model; run it with/before the paired code deploy (the form,
checkout guard, and buyer pills read the new columns). #38 (`harden-cook-private.sql`) run
