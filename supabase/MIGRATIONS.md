...
**Status: 25 of 26 applied — #26 (`add-listing-ingredients.sql`) is NOT yet run.**
Paste it into the SQL editor and run it *before* deploying the ingredients-field code
(creating/editing a listing writes the column). #25 applied + verified live 2026-07-29
