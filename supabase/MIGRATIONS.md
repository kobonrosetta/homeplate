...
**Status: 38 of 38 applied.** #38 (`harden-cook-private.sql`) run by hand in the
Supabase SQL editor on 2026-08-02, after the code deploy that moved the permit-photo
write to the service role (migration-LAST order observed). #34–#37 were run by hand in
