...
--  permit can't verify a kitchen, and indexes permit_number
--  (case-insensitive) for the signup lookup — the list is now
--  ~174 real rows instead of ~5, and it's the hot path when a
--  cook finishes onboarding.
--
